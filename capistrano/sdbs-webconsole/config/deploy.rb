...
# app settings
set :application, "sdbs-webconsole"
set :war_base, "#{application}"
set :repository,  "git@#{git_host}:sdbs-webconsole.git"
set :scm, :git
set :branch, "master"
...
after "deploy:update" do
  ...
  try_sudo "ln -s #{current_path}/target/#{war_base}.war #{tomcat_webapps}/#{war_base}.war"
end
