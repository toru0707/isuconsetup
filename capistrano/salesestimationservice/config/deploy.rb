...
set :deploy_to_host, "#{mvphosts['da_host']}"

# app settings
set :application, "salesestimationservice"
set :war_base, "SalesEstimationService"
...
set :build_script, "mvn clean compile assembly:single -Dmaven.test.skip=true"
